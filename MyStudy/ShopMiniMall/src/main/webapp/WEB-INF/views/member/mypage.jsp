...
<input type="text" value="${login.post }" name="post" id="sample4_postcode" placeholder="우편번호" readonly>
<input type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기" ><br>
<input type="text" value="${sessionScope.login.addr1 }" name="addr1" id="sample4_roadAddress" placeholder="도로명주소" readonly>
<input type="text" value="${sessionScope.login.addr2 }" name="addr2" id="sample4_jibunAddress" placeholder="지번주소" readonly>
...
<input type="text" value="${login.phone2 }" name="phone2" id="phone2">-<input type="text" value="${login.phone3 }" name="phone3" id="phone3">
<br>
